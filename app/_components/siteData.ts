export const site = {
  ...
  description: "Rehab to Performance · 재활에서 운동까지",
  phone: "010-2418-8400",
...
export const serviceItems = [
  {
    ...
    target: "부모님 세대 · 걷기/계단/허리/무릎/어깨 불편감",
    ...
    bullets: ["통증 및 생활동작 체크", "관절 가동성 운동", "균형 및 보행 안정성 훈련", "하체 근력 회복", "집에서 할 수 있는 숙제 제공"],
  },
  {
    number: "02",
    ...
    target: "복귀 준비 선수 · 유소년 선수 · 엘리트 학생 선수",
    message: "재활에서 복귀까지, 다시 경기장으로 돌아가기 위한 과정.",
    description:
      "부상 이후 남아있는 불안정성, 근력 저하, 움직임 제한, 체력 저하를 확인하고 다시 훈련과 경기로 복귀할 수 있도록 단계적으로 준비합니다.",
  ...
  },
  {
    ...
    description:
      "현재 몸 상태와 움직임을 확인하고, 무리 없는 범위에서 운동을 시작해 통증 관리, 근력 회복, 체력 향상을 함께 목표로 합니다.",
