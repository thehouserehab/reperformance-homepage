...
const flowSteps = [
  ...
  ["03", "상담 완료 후 NORE 안내", "필요한 회원에게 담당 코치가 가입 링크와 이용 방법을 개별 안내합니다."],
] as const;
        ...
        <div className={`container ${styles.heroInner}`}>
          <div>
            ...
            <p className={styles.lead}>
              ...
              회원에게만 담당 코치가 NORE 가입 링크와 이용 방법을 안내해드립니다.
            </p>
          ...
          <aside className={styles.notice} aria-label="NORE 이용 안내">
            <strong>상담 완료 후 회원관리 안내</strong>
            <p>상담 신청만으로 NORE 가입이 진행되지는 않습니다. 상담을 마친 뒤 필요한 회원에게 담당 코치가 별도로 안내합니다.</p>
          </aside>
        </div>
      </section>
      ...
      <section className={`section ${styles.bottomSection}`}>
        <div className={`container ${styles.bottomInner}`}>
          <div>
            ...
            <p>상담 완료 후 수업과 개인 관리가 필요한 회원에게만 NORE 이용 방법을 전달합니다.</p>
          </div>
