...
| 메뉴 | 경로 | 첫 질문 | 포함 범위 |
|---|---|---|---|
| 오늘 | `/student` | 오늘 무엇을 하면 되는가? | 컨디션, 필수 과제, 공부 타이머, 다음 일정 |
| 캘린더 | `/calendar` | 공부와 운동 일정이 어떻게 이어지는가? | 월간 일정, 일정 목록, 확인형 일정 도우미 |
...
- `/student/privacy`: 부모님에게 공개할 정보 선택
- `/student#study-timer`: 오늘 화면의 공부 타이머
