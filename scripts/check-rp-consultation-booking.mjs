...
assert.ok(notificationSource.includes('RP_APPLICATION_NOTIFICATION_SECRET'));
...
const dedicatedNotificationScript = read('integrations/google-apps-script/Notification.gs');
assert.ok(dedicatedNotificationScript.includes("getProperty('RP_APPLICATION_NOTIFICATION_SECRET')"));
assert.ok(dedicatedNotificationScript.includes("getProperty('RP_NOTIFICATION_EMAIL')"));
assert.ok(dedicatedNotificationScript.includes('CacheService.getScriptCache()'));
assert.ok(dedicatedNotificationScript.includes('LockService.getScriptLock()'));
assert.ok(dedicatedNotificationScript.includes('MailApp.sendEmail'));
assert.ok(!dedicatedNotificationScript.includes('SpreadsheetApp'));
assert.ok(!dedicatedNotificationScript.includes('phone'));
assert.ok(!dedicatedNotificationScript.includes('parq'));
assert.ok(dedicatedNotificationScript.includes('Gmail 알림 연동 테스트'));
assert.ok(!dedicatedNotificationScript.includes('?뚮'));
