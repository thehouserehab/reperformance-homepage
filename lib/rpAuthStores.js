...
export async function verifyAuthAccountFromStores(username, password) {
  ...
  if (envAccount) return { account: envAccount, source: 'env', reason: 'success', accountFound: true };
  ...
  if (sheetAccount) return { account: sheetAccount, source: 'sheet', reason: 'success', accountFound: true };
